...
| hooks.registry.distribution.defaultValueTemplateConfigMap.create | bool | `true` |  |
| hooks.registry.distribution.defaultValueTemplateConfigMap.name | string | `"default-registry-distribution-helm-values-template"` |  |
