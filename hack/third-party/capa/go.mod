...
require sigs.k8s.io/cluster-api-provider-aws/v2 v2.10.1
...
replace sigs.k8s.io/cluster-api-provider-aws/v2 => github.com/nutanix-cloud-native/cluster-api-provider-aws/v2 v2.9.1-0.20260211230105-e1028440f24b
