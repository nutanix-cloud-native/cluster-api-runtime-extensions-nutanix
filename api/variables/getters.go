...
func RegistryAddon(cluster *clusterv1beta2.Cluster) (*carenv1.RegistryAddon, error) {
...
func KubeProxyMode(cluster *clusterv1beta2.Cluster) (*carenv1.KubeProxyMode, error) {
	spec, err := UnmarshalClusterConfigVariable(cluster.Spec.Topology.Variables)
	if err != nil {
		return nil, fmt.Errorf("failed to unmarshal cluster variable: %w", err)
	}
...
func KubeProxyIsDisabled(cluster *clusterv1beta2.Cluster) (bool, error) {
