...
const (
	...
	// WireImageCredentialProviderByDefaultVariableName is the patch variable name for the flag that
	// wires the kubelet dynamic credential provider on every node even when no registry/mirror is configured.
