...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericCNI) DeepCopyInto(out *GenericCNI) {
	*out = *in
	in.AddonConfig.DeepCopyInto(&out.AddonConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericCNI.
func (in *GenericCNI) DeepCopy() *GenericCNI {
	if in == nil {
		return nil
	}
	out := new(GenericCNI)
