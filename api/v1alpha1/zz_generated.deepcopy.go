...
func (in *GenericAddons) DeepCopyInto(out *GenericAddons) {
	*out = *in
	...
	if in.InClusterRegistry != nil {
		in, out := &in.InClusterRegistry, &out.InClusterRegistry
		*out = new(InClusterRegistry)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InClusterRegistry) DeepCopyInto(out *InClusterRegistry) {
	*out = *in
	if in.Configuration != nil {
		in, out := &in.Configuration, &out.Configuration
		*out = new(InClusterRegistryConfiguration)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InClusterRegistry.
func (in *InClusterRegistry) DeepCopy() *InClusterRegistry {
	if in == nil {
		return nil
	}
	out := new(InClusterRegistry)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InClusterRegistryConfiguration) DeepCopyInto(out *InClusterRegistryConfiguration) {
	*out = *in
	if in.BundleLoader != nil {
		in, out := &in.BundleLoader, &out.BundleLoader
		*out = new(RegistryBundleLoader)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InClusterRegistryConfiguration.
func (in *InClusterRegistryConfiguration) DeepCopy() *InClusterRegistryConfiguration {
	if in == nil {
		return nil
	}
	out := new(InClusterRegistryConfiguration)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RegistryBundleLoader) DeepCopyInto(out *RegistryBundleLoader) {
	*out = *in
	if in.FromVolumes != nil {
		in, out := &in.FromVolumes, &out.FromVolumes
		*out = make([]RegistryBundleVolumeSource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RegistryBundleLoader.
func (in *RegistryBundleLoader) DeepCopy() *RegistryBundleLoader {
	if in == nil {
		return nil
	}
	out := new(RegistryBundleLoader)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RegistryBundleVolumeSource) DeepCopyInto(out *RegistryBundleVolumeSource) {
	*out = *in
	if in.HostPath != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RegistryBundleVolumeSource.
func (in *RegistryBundleVolumeSource) DeepCopy() *RegistryBundleVolumeSource {
	if in == nil {
		return nil
	}
	out := new(RegistryBundleVolumeSource)
	in.DeepCopyInto(out)
	return out
}
