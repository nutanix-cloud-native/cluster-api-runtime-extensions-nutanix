...
KINDEST_NODE_VERSION_v1.31 ?= v1.31.12
KINDEST_NODE_VERSION_v1.32 ?= v1.32.8
KINDEST_NODE_VERSION_v1.33 ?= v1.33.4
KINDEST_NODE_VERSION_v1.34 ?= v1.34.0
# Allow easy override of Kubernetes version to use via `make KIND_KUBERNETES_VERSION=v1.23` to use in CI
KIND_KUBERNETES_VERSION ?= v1.34
