...
var (
	...
	GenericInfrastructureMachineCRD = untypedCRD(
		InfrastructureGroupVersion.WithKind(GenericInfrastructureMachineKind),
	)
	...
	GenericInfrastructureMachineTemplateCRD = untypedCRD(
		InfrastructureGroupVersion.WithKind(GenericInfrastructureMachineTemplateKind),
	)
	...
	GenericInfrastructureMachinePoolTemplateCRD = untypedCRD(
		InfrastructureGroupVersion.WithKind(GenericInfrastructureMachinePoolTemplateKind),
	)
	...
	GenericInfrastructureMachinePoolCRD = untypedCRD(
		InfrastructureGroupVersion.WithKind(GenericInfrastructureMachinePoolKind),
	)
	...
	GenericInfrastructureClusterCRD = untypedCRD(
		InfrastructureGroupVersion.WithKind(GenericInfrastructureClusterKind),
	)
	...
	GenericInfrastructureClusterTemplateCRD = untypedCRD(
		InfrastructureGroupVersion.WithKind(GenericInfrastructureClusterTemplateKind),
	)
	...
	TestInfrastructureClusterTemplateCRD = testInfrastructureClusterTemplateCRD(
		InfrastructureGroupVersion.WithKind(TestInfrastructureClusterTemplateKind),
	)
	...
	TestInfrastructureClusterCRD = testInfrastructureClusterCRD(
		InfrastructureGroupVersion.WithKind(TestInfrastructureClusterKind),
	)
	...
	TestInfrastructureMachineTemplateCRD = testInfrastructureMachineTemplateCRD(
		InfrastructureGroupVersion.WithKind(TestInfrastructureMachineTemplateKind),
	)
	...
	TestInfrastructureMachinePoolTemplateCRD = testInfrastructureMachinePoolTemplateCRD(
		InfrastructureGroupVersion.WithKind(TestInfrastructureMachinePoolTemplateKind),
	)
	...
	TestInfrastructureMachinePoolCRD = testInfrastructureMachinePoolCRD(
		InfrastructureGroupVersion.WithKind(TestInfrastructureMachinePoolKind),
	)
	...
	TestInfrastructureMachineCRD = testInfrastructureMachineCRD(
		InfrastructureGroupVersion.WithKind(TestInfrastructureMachineKind),
	)
)

func testInfrastructureClusterTemplateCRD(
...
func testInfrastructureClusterCRD(
	gvk schema.GroupVersionKind,
) *apiextensionsv1.CustomResourceDefinition {
	return generateCRD(gvk, map[string]apiextensionsv1.JSONSchemaProps{
		"metadata": {
...
func testInfrastructureMachineTemplateCRD(
	gvk schema.GroupVersionKind,
) *apiextensionsv1.CustomResourceDefinition {
	return generateCRD(gvk, map[string]apiextensionsv1.JSONSchemaProps{
		"metadata": {
...
func testInfrastructureMachineCRD(
	gvk schema.GroupVersionKind,
) *apiextensionsv1.CustomResourceDefinition {
	return generateCRD(gvk, map[string]apiextensionsv1.JSONSchemaProps{
		"metadata": {
...
func testInfrastructureMachinePoolCRD(
	gvk schema.GroupVersionKind,
) *apiextensionsv1.CustomResourceDefinition {
	return generateCRD(gvk, map[string]apiextensionsv1.JSONSchemaProps{
		"metadata": {
