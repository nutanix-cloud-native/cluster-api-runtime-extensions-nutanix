...
func (in *ClusterBuilder) DeepCopyInto(out *ClusterBuilder) {
	*out = *in
	...
	if in.network != nil {
		...
		*out = new(clusterv1.ClusterNetwork)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ClusterClassBuilder) DeepCopyInto(out *ClusterClassBuilder) {
	*out = *in
	...
	if in.controlPlaneMHC != nil {
		...
		*out = new(clusterv1.ControlPlaneClassHealthCheck)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.machinePoolClasses != nil {
		...
		*out = make([]clusterv1.MachinePoolClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.statusVariables != nil {
		...
		*out = make([]clusterv1.ClusterClassStatusVariable, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.patches != nil {
		...
		*out = make([]clusterv1.ClusterClassPatch, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ClusterTopologyBuilder) DeepCopyInto(out *ClusterTopologyBuilder) {
	*out = *in
	if in.workers != nil {
		...
		*out = new(clusterv1.WorkersTopology)
		(*in).DeepCopyInto(*out)
	}
	if in.controlPlaneMHC != nil {
		in, out := &in.controlPlaneMHC, &out.controlPlaneMHC
		*out = new(clusterv1.ControlPlaneTopologyHealthCheck)
		(*in).DeepCopyInto(*out)
	}
	if in.variables != nil {
		in, out := &in.variables, &out.variables
		*out = make([]clusterv1.ClusterVariable, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MachineDeploymentBuilder) DeepCopyInto(out *MachineDeploymentBuilder) {
	*out = *in
	...
	if in.status != nil {
		...
		*out = new(clusterv1.MachineDeploymentStatus)
		(*in).DeepCopyInto(*out)
	}
...
func (in *MachineDeploymentClassBuilder) DeepCopyInto(out *MachineDeploymentClassBuilder) {
	*out = *in
	...
	if in.machineHealthCheckClass != nil {
		...
		*out = new(clusterv1.MachineDeploymentClassHealthCheck)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.strategy != nil {
		...
		*out = new(clusterv1.MachineDeploymentClassRolloutStrategy)
		(*in).DeepCopyInto(*out)
	}
	if in.namingStrategy != nil {
		in, out := &in.namingStrategy, &out.namingStrategy
		*out = new(clusterv1.MachineDeploymentClassNamingSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *MachineDeploymentTopologyBuilder) DeepCopyInto(out *MachineDeploymentTopologyBuilder) {
	*out = *in
	...
	if in.mhc != nil {
		...
		*out = new(clusterv1.MachineDeploymentTopologyHealthCheck)
		(*in).DeepCopyInto(*out)
	}
	if in.variables != nil {
		in, out := &in.variables, &out.variables
...
func (in *MachineHealthCheckBuilder) DeepCopyInto(out *MachineHealthCheckBuilder) {
	*out = *in
	...
	if in.unhealthyMachineConditions != nil {
		...
		*out = make([]clusterv1.UnhealthyMachineCondition, len(*in))
		copy(*out, *in)
	}
	if in.unhealthyNodeConditions != nil {
		in, out := &in.unhealthyNodeConditions, &out.unhealthyNodeConditions
		*out = make([]clusterv1.UnhealthyNodeCondition, len(*in))
		copy(*out, *in)
	}
...
func (in *MachinePoolBuilder) DeepCopyInto(out *MachinePoolBuilder) {
	*out = *in
	...
	if in.status != nil {
		in, out := &in.status, &out.status
		*out = new(clusterv1.MachinePoolStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.minReadySeconds != nil {
		in, out := &in.minReadySeconds, &out.minReadySeconds
...
func (in *MachinePoolClassBuilder) DeepCopyInto(out *MachinePoolClassBuilder) {
	*out = *in
	...
	if in.namingStrategy != nil {
		in, out := &in.namingStrategy, &out.namingStrategy
		*out = new(clusterv1.MachinePoolClassNamingSpec)
		(*in).DeepCopyInto(*out)
	}
}
