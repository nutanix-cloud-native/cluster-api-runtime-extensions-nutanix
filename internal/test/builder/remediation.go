...
var (
	...
	RemediationGroupVersion = schema.GroupVersion{
		Group:   "remediation.external.io",
		Version: "v1beta1",
	}

	// GenericRemediationCRD is a generic infrastructure remediation CRD.
	GenericRemediationCRD = untypedCRD(
		RemediationGroupVersion.WithKind("GenericExternalRemediation"),
	)

	// GenericRemediationTemplateCRD is a generic infrastructure remediation template CRD.
	GenericRemediationTemplateCRD = untypedCRD(
		RemediationGroupVersion.WithKind("GenericExternalRemediationTemplate"),
	)
)
