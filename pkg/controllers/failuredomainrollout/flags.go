...
func (o *Options) AddFlags(flags *pflag.FlagSet) {
	pflag.CommandLine.BoolVar(
		...
		true,
		"Enable failure domain rollout controller to monitor cluster.status.failureDomains and trigger rollouts on KubeAdmControlPlane when there are meaningful changes.",
	)
