...
func TestCopyClusterClassAndTemplates(t *testing.T) {
	...
	testCases := []struct {
		...
		createErrForKind string
		getErrForKind    string
		expectErr        error
		expectNumCopies  int
	}{
		{
		...
		},
		{
			...
			createErrForKind: "GenericInfrastructureClusterTemplate",
...
func interceptors(createdObjs *[]client.Object, getErrForKind, createErrForKind string) interceptor.Funcs {
	return interceptor.Funcs{
		Get: func(_ context.Context, _ client.WithWatch, key client.ObjectKey, obj client.Object, _ ...client.GetOption) error {
			if getErrForKind != "" && obj.GetObjectKind().GroupVersionKind().Kind == getErrForKind {
				return errFakeGet
			}
			return nil
		},
		Create: func(_ context.Context, _ client.WithWatch, obj client.Object, _ ...client.CreateOption) error {
			if createErrForKind != "" && obj.GetObjectKind().GroupVersionKind().Kind == createErrForKind {
