...
var _ = Describe("Generate Volumes patches for Worker", func() {
	...
	testDefs := []capitest.PatchTestDef{
		...
		{
			Name: "Root volume for worker set",
		...
		{
			Name: "Non-root volumes for worker set",
			Vars: []runtimehooksv1.Variable{
				capitest.VariableWithValue(
					v1alpha1.WorkerConfigVariableName,
					v1alpha1.AWSVolumes{
		...
		{
			Name: "Both root and non-root volumes for worker set",
			Vars: []runtimehooksv1.Variable{
				capitest.VariableWithValue(
					v1alpha1.WorkerConfigVariableName,
					v1alpha1.AWSVolumes{
