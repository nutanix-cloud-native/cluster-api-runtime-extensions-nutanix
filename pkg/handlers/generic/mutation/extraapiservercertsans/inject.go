...
func (h *extraAPIServerCertSANsPatchHandler) Mutate(
	...
	return patches.MutateIfApplicable(
		...
		func(obj *controlplanev1.KubeadmControlPlaneTemplate) error {
			...
			obj.Spec.Template.Spec.KubeadmConfigSpec.ClusterConfiguration.APIServer.CertSANs = append(
				obj.Spec.Template.Spec.KubeadmConfigSpec.ClusterConfiguration.APIServer.CertSANs,
				extraAPIServerCertSANsVar...)
