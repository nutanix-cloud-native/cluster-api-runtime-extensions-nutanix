...
type controllermanagerPatchHandler struct{}

func NewPatch() *controllermanagerPatchHandler {
	return &controllermanagerPatchHandler{}
}

func (h *controllermanagerPatchHandler) Mutate(
	ctx context.Context,
	...
	return patches.MutateIfApplicable(
		...
		func(obj *controlplanev1.KubeadmControlPlaneTemplate) error {
			...
			controllerManager := &obj.Spec.Template.Spec.KubeadmConfigSpec.ClusterConfiguration.ControllerManager
