...
func NewPatch() *imageRepositoryPatchHandler {
	return newImageRepositoryPatchHandler(v1alpha1.ClusterConfigVariableName, VariableName)
}
...
func (h *imageRepositoryPatchHandler) Mutate(
	...
	imageRepositoryVar, err := variables.Get[string](
		vars,
		h.variableName,
		h.variableFieldPath...,
	)
	...
	return patches.MutateIfApplicable(
		...
		func(obj *controlplanev1.KubeadmControlPlaneTemplate) error {
			...
			obj.Spec.Template.Spec.KubeadmConfigSpec.ClusterConfiguration.ImageRepository = imageRepositoryVar
