...
import (
	...
	"github.com/nutanix-cloud-native/cluster-api-runtime-extensions-nutanix/pkg/handlers/v6/eks/mutation/testutils"
	"github.com/nutanix-cloud-native/cluster-api-runtime-extensions-nutanix/test/helpers"
)

func TestRegionPatch(t *testing.T) {
	gomega.RegisterFailHandler(Fail)
	RunSpecs(t, "EKS Region mutator suite")
}

var _ = Describe("Generate EKS Region patches", func() {
	// only add eks region patch
