...
### Other Changes
* build(chore): bump ccm to v0.5.7 and update runners by @Vedansh074 in https://github.com/nutanix-cloud-native/cluster-api-runtime-extensions-nutanix/pull/1668
